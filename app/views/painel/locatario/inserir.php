                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <h3 class="mb-0">Inserir Locatário</h3>
                                </div>
                        ...
                        <div class="card-body">
                            <form id="formAdicionarLocatario">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control maskTelCel" required name="telefone" placeholder="Telefone ou Celular" />
                                        </div>
                                    </div>
                                </div>
